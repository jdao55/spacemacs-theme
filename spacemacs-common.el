...
(defun create-spacemacs-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (base          (if (eq variant 'dark) (if (true-color-p) "#c4c4c4" "#b2b2b2") (if (true-color-p) "#655370" "#5f5f87")))
        ...
        (comment       (if (eq variant 'dark) (if (true-color-p) "#737373" "#008787") (if (true-color-p) "#2aa1ae" "#008787")))
        (comment-light (if (eq variant 'dark) (if (true-color-p) "#999999" "#008787") (if (true-color-p) "#a49da5" "#008787")))
        ...
        (str           (if (eq variant 'dark) (if (true-color-p) "#5dc2a3" "#2aa198") (if (true-color-p) "#2d9574" "#2aa198")))
