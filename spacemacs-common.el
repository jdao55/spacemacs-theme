...
(defun create-spacemacs-theme (variant theme-name)
  (let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (comment       (if (eq variant 'dark) (if (true-color-p) "#878787" "#008787") (if (true-color-p) "#2aa1ae" "#008787")))
        (comment-light (if (eq variant 'dark) (if (true-color-p) "#757575" "#008787") (if (true-color-p) "#a49da5" "#008787")))
